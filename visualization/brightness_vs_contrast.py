...
df_contr = pd.read_csv(f'visualization/non_linear_mapping_data/Contrast/Contrast_poly_k_results.csv')
df_bright = pd.read_csv(f'visualization/non_linear_mapping_data/Brightness/Brightness_poly_k_results.csv')
...
plt.tight_layout()
file_name = '/home/ekagra/Documents/GitHub/MasterArbeit/final_plots/contrast_bright_acc.pdf'
