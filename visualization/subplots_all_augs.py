...
if __name__ == "__main__":
    ...
    ax[2, 0].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[0, 1].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[0, 0].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[0, 3].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[0, 2].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[1, 0].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[1, 1].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[1, 2].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[1, 3].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[2, 1].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    ax[2, 2].plot(const_severity, const_k, '-', label=f'k={2}, Confidence$\geq${th}', color=constk_color, linewidth=2)
    ...
    (f'k=2, Confidence$\geq${th}', constk_color, '-'),
