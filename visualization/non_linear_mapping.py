...
from visualization.evaluate import evaluate_model
import torch
import time
from augment_dataset import seed_worker


def get_plot(augmentation_type, model, dataset_split=100, worker_init_fn=None, generator=None, iq_metric='ncc'):
    print(
...
if __name__ == "__main__":
    ...
    for augmentation_type in augmentation_types:
        get_plot(augmentation_type, model=net, dataset_split=500, worker_init_fn=seed_worker, generator=g)
